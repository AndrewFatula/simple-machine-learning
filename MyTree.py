...
tree = compute_tree(data.train, data.variables, data.class_variable, data.classes, data.p_initial, 50, min_samples_split = 1000, min_samples_leaf = 1000, n_quantiles = 20)
...
predicted = predictions(data.test, tree, data.variables, data.class_variable)
