...
that data you can find in data directory.

compute_tree - funcion that builds tree recursively, the main principle of building tree is findind specific value of one of the given features that separates classes the most.

In finding split value was used the concept of information enropy.  
