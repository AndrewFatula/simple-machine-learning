...
compute_tree - funcion that builds tree recursively, the main principle of building tree is findind specific value of one of the given features that separates two classes the most in each splitted part.

In finding split value have been used the concept of information enropy.  
